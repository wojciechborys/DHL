...
function assets() {
    global $wp_query;
    wp_enqueue_style('sage/css', Assets\asset_path('main.css', 'asset-sources/dhlknowledge/dist'), null, "1.2.0", null);
    ...
    wp_enqueue_script('sage/js', Assets\asset_path('main.js', 'asset-sources/dhlknowledge/dist'), ['jquery'], "1.2.0", true);
