...
<?php if ($enable_header) : ?>
    <section class="background_image background_image--header d-flex align-items-center"
             style="background-image:url('<?php echo $image_bg_link; ?>');">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-7 col-xl-5">
                    <span class="background_image--title d-block font__title--01 font__color--gray mb-2" <?php echo $color_text; ?>>
                        <?php echo $title; ?>
                    </span>
