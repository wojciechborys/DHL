...
<section class="services_table mb-5 pb-4">
            ...
            <?php if (have_rows('kafel')):
                while (have_rows('kafel')) :
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mb-5">
                        <div class="services_table--item services_table--item--bf services_table--item--bf--<?php echo get_row_index(); ?> bg__color--gray-light text-center text-md-left text-center d-flex flex-column bd-highlight">
                            <span class="services_table--item--bf--title text-uppercase font__title--0555 font__color--default-head text-center"><?php echo get_sub_field('title'); ?></span>
                            ...
                            <?php if (get_sub_field('enable__tooltip')): ?>
                                <p class="text-center mt-4">
                                    <img src="<?php echo esc_url((get_sub_field('tooltip__icon'))['url']); ?>"
                                         ...
                                         <a href="#" class="infoTooltip" data-toggle="tooltip" title="<?php echo get_sub_field('tooltip__text'); ?>">?</a>
