        ...
        <div class="container">
            ...
            <form action="<?= esc_url(home_url('/')); ?>" method="post">
                <div class="row content-calc__calculator">
                    <label class="col-12 col-md-6 col-lg-5 form-group content-calc__label content-calc__label--country order-2 order-lg-1 pr-lg-0">
                    ...
                    <div class="col-12 col-md-12 col-lg-2 d-flex align-items-end justify-content-center mb-3 order-1 order-lg-2">
                    ...
                    <label class="col-12 col-md-6 col-lg-5 form-group content-calc__label content-calc__label--country order-3 order-lg-3 pl-lg-0">
    ...
    ?><div class="content-calc__results container" data-calc-results >
        <div class="row content-calc__results-wrapper">
            ...
            <div class="col-12 col-sm-6 col-lg-3 content-calc__result content-calc__result--call<?php if ($chosenVariation === 1) : ?> order-4<?php endif; ?>" data-calc-result="postals" data-result-version="normal">
                <div class="content-calc__result-inner">
                    <div class="content-calc__badge text-uppercase font__subtitle--011"><?php echo Polylang\t9n('Najlepsza opcja'); ?></div>
