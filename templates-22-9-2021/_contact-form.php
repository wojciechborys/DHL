    ...
    <div class="contact-form__wrapper" data-form-wrapper>
        <div class="contact-form__embed">
            ...
            if (defined('MM_POLYLANG_ACTIVE') && MM_POLYLANG_ACTIVE && pll_current_language('slug') === 'en') :
                ?>
                <iframe class="optanon-category-YOU01 contact-form__iframe" id="formularzIon" name="dhl-express-form-iframe" data-src="https://shipping.dhl.com.pl/international-shipping-for-business"></iframe>
            <?php
            else :
                ?>
                <iframe class="optanon-category-YOU01 contact-form__iframe" id="formularzIon" name="dhl-express-form-iframe" data-src="https://shipping.dhl.com.pl/przesylki-miedzynarodowe-dla-firm-2/"></iframe>
            <?php
            endif;
            ?>
