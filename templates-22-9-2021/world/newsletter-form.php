            ...
            <form id="lead-form">
                ...
                <div class="row justify-content-center">
                    <div class="col-12<?php if (!$inSidebar) : ?> col-lg-10 col-xl-9<?php endif; ?>">
                        ...
                        <p class="newsletter__text">Szukasz pomocnych i&nbsp;ciekawych treści z&nbsp;obszaru e-commerce,
                            biznesu, logistyki?<br/>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row justify-content-center newsletter__form-row">
                            <div class="col-12 col-sm-10 <?php if ($inSidebar) : ?>col-md-11 col-lg-9<?php else : ?>col-lg-4 col-xl-3<?php endif; ?>">
                                <input type="text" name="name"
                                       class="form-control newsletter__input newsletter__input--text" placeholder="Imię"
                            ...
                            <div class="col-12 col-sm-10 <?php if ($inSidebar) : ?>col-md-11 col-lg-9<?php else : ?>col-lg-4 col-xl-3<?php endif; ?>">
                                <input type="text" name="email"
                                       ...
                                       placeholder="Adres e-mail" data-newsletter-input/>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center newsletter__form-row">
                            <div class="col-12 col-sm-10 <?php if ($inSidebar) : ?>col-md-11 col-lg-9<?php else: ?>col-md-10 col-lg-8 col-xl-6<?php endif; ?>">
                                <label for="newsletterTermsConsent"
                                       class="form-check-label newsletter__label newsletter__label--checkbox"><input
                                            id="newsletterTermsConsent" type="checkbox" name="terms-consent" value="tak"
                                            class="form-check-input newsletter__input newsletter__input--checkbox"
                                            data-newsletter-input/> Tak, zapoznałem się z <a
                                            href="<?= home_url('swiat/regulamin-uslugi-newsletter/'); ?>"
                                            target="_blank">Regulaminem</a>. Akceptuję jego treść i chcę otrzymywać
                                    aktualne informacje i materiały premium.
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center newsletter__form-row">
                            <div class="col-12 col-sm-10 <?php if ($inSidebar) : ?>col-md-11 col-lg-9<?php else: ?>col-md-10 col-lg-5 col-xl-3<?php endif; ?>">
                                <button class="btn btn-primary newsletter__btn" data-access-submit>Zamawiam Newsletter
                                </button>
                            </div>
                        </div>
        ...
        <div class="newsletter__step newsletter__step--2 newsletter__step--next" data-newsletter-step="2">
            <div class="row justify-content-center">
                ...
                if ($inSidebar) :
                    ...
                    <div class="col-12">
                        <p class="newsletter__text">Nasze wiadomości wysyłane są z&nbsp;adresu: poland@dhl-news.com.
