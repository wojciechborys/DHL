            ...
            <div class="row">
                <div class="col-12 fp-custom-content__content">
                    ...
                    if ($customContentTtile) :
                        ?><h2 class="fp-custom-content__title"><?= Tags\customContentTitle(); ?></h2><?php
                    endif;
                    ?>
                    ...
                    <div class="employment-offers__content col-12 col-md-7 col-lg-6 order-2">
                        <div class="row justify-content-end">
                            <div class="employment-offers__offers-intro col-12 col-xl-10">
                                <h2 class="employment-offers__title"><?= $optionsHelper->get('offers::offers1_title'); ?></h2>
            ...
            <div class="employment-offers__container container">
                <div class="employment-offers__row row">
                    ...
                    <div class="employment-offers__content col-12 col-md-7 col-lg-6 order-2 order-md-1">
                        <div class="row justify-content-end">
                            <div class="employment-offers__offers-intro col-12 col-xl-10">
                                <h2 class="employment-offers__title"><?= $optionsHelper->get('offers::offers2_title'); ?></h2>
            ...
            <div class="employment-offers__container container">
                <div class="employment-offers__row row">
                    ...
                    <div class="employment-offers__content col-12 col-md-7 col-lg-6 order-2">
                        <div class="row justify-content-end">
                            <div class="employment-offers__offers-intro col-12 col-xl-10">
                                <h2 class="employment-offers__title"><?= $optionsHelper->get('offers::offers3_title'); ?></h2>
    ...
    if ($query->have_posts()) :
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <h2 class="discover-dhl__title"><?= $optionsHelper->get('front_discover::title'); ?></h2>
