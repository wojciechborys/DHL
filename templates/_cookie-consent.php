    ...
    <div class="container cookie-consent__container">
        <div class="row cookie-consent__row">
            <div class="col-12 cookie-consent__col">
                <button type="button" class="close" aria-label="<?= Polylang\t9n_attr('Zamknij'); ?>" data-close-cookies>
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <div class="col-12 cookie-consent__col">
                <p><?= Polylang\t9n('Stosujemy pliki cookie na naszej stronie internetowej. Pliki cookie są stosowane do poprawy działania i korzystania z naszej strony Internetowej, a także dla celów analitycznych i reklamowych. Aby dowiedzieć się więcej na temat plików cookie, sposobu ich wykorzystania oraz sposobu zmiany ustawień cookie, dowiedz się więcej <a href="http://www.dhl.com.pl/pl/zasady_korzystania_ze_strony_internetowej.html#privacy" target="_blank" data-close-cookies>tutaj</a>. Korzystając z tej strony bez zmiany ustawień, wyrażasz zgodę na stosowanie plików cookie.'); ?></p>
            </div>
        </div>
    </div>
</div>
