...
<section class="content-calc calculator my-5" id="calculator">
    <div class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6 mx-auto">
                    <h2 class="font__title--01 font__color--gray text-uppercase text-center d-block mb-5 pt-0">
                        <?php the_sub_field('calculator_heading'); ?>
                    </h2>
                </div>
            </div>
                ...
                <div class="col-lg-10 col-xl-8 mx-auto pr-xl-0 pl-xl-0">
                    <form action="<?= esc_url(home_url('/')); ?>" method="post">
                        <div class="row content-calc__calculator">
                            <label
                                    class="col-12 col-md-6 col-lg-5 form-group content-calc__label content-calc__label--country order-2 order-lg-1 pr-lg-0" style="display: none">
                                <?= Polylang\t9n('Kod pocztowy'); ?>*
                                <input
                                        class="form-control content-calc__input content-calc__input--text content-calc__input--postal"
                                        type="text" name="rate_calc[postal]" placeholder="xx-xxx"
                                        data-calc-field="postal"/>
                            </label>

                            <div
                                    class="col-12 col-md-12 col-lg-2 d-flex align-items-end justify-content-center mb-3 order-2 order-lg-2">
                                <img src="<?php echo esc_url(Assets\asset_path('images/plane.png',
                                    'asset-sources/dhlexpress/dist')); ?>" alt="Plane" class="img-fluid mb-1 plane"/>
                            </div>

                            <label
                                    class="col-12 col-md-6 col-lg-5 form-group content-calc__label content-calc__label--country order-1 order-lg-1 pl-lg-0 mr-5 margin--country">
                                <?= Polylang\t9n('Kraj przeznaczenia'); ?>*

                                <select id="country" class="form-control content-calc__input content-calc__input--text"
                        ...
                        <div class="row content-calc__calculator">
                            <label class="col-6 col-md-3 form-group content-calc__label content-calc__label--weight">
                                ...
                                <input
                                        ...
                                        type="number" name="rate_calc[weight]" placeholder="0.3" min="0.1" value="0.3"
                            ...
                            <label class="col-6 col-md-3 form-group content-calc__label content-calc__label--length">
                                ...
                                <input
                                        ...
                                        type="number" name="rate_calc[length]" placeholder="30" min="1" value="30"
                            ...
                            <label class="col-6 col-md-3 form-group content-calc__label content-calc__label--width">
                                ...
                                <input
                                        ...
                                        type="number" name="rate_calc[width]" placeholder="25" min="1" value="25"
                            ...
                            <label class="col-6 col-md-3 form-group content-calc__label content-calc__label--height">
                                ...
                                <input
                                        ...
                                        type="number" name="rate_calc[height]" placeholder="1" min="1" value="1"
                        ...
                        <div class="row">
                            <div class="col-12 text-center content-calc__btn-wrapper">
                                <button class="btn btn--auto btn--red btn-primary text-uppercase btn--calc btn--wide"
                                        ...
                                        data-calc-field="calculate"><?php the_field('calculator_text_button',
                                        'option'); ?></button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="bg__color--gray-light">
        ...
        <div class="content-calc__results container" data-calc-results>
            <div class="row content-calc__results-wrapper">
                ...
                <div class="col-12 col-sm-6 col-lg-3 content-calc__result content-calc__result--call<?php if ($chosenVariation === 1) : ?> order-1<?php endif; ?>" data-calc-result="postals" data-result-version="normal">
                    <div class="content-calc__result-inner">
                        <div class="content-calc__badge text-uppercase font__subtitle--011 image-red">
                            <?php echo Polylang\t9n('Oferta dla firm'); ?>
                        </div>
                        ...
                        <a href="<?php echo esc_url(get_field('calculator_button4_url', 'option')); ?>" class="btn btn-primary btn--wide content-calc__btn d-block font__title--07 text-uppercase mt-5"><?= Polylang\t9n('Sprawdź'); ?></a>
                ...
                <div
                        class="col-12 content-calc__disclaimer<?php if ($chosenVariation === 1) : ?> order-5<?php endif; ?> mt-3"
                        data-calc-result>
