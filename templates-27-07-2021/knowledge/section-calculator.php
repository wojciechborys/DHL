        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 col-lg-10 col-xl-10 mx-auto">
                    <h2 class="font__title--022 font__color--gray text-uppercase text-center d-block mb-5 pb-0 pb-lg-4">
                ...
                <div class="col-lg-3 pr-xl-5">
                    <div class="d-flex justify-content-center">
                        <div class="content-calc__result-inner position-relative">
                            ...
                            <!--                        <a href="--><?php //echo $targetUrl; ?><!--"-->
                            <!--                           class="btn btn-primary btn--wide content-calc__btn d-block font__title--07 text-uppercase mt-5">--><?//= Polylang\t9n('Sprawdź'); ?><!--</a>-->
                            <!--                        <p class="content-calc__shipment-time el__color--gray_light">--><?php //echo Polylang\t9n('Szybkie dostawy i odbiory z 220 krajów i terytoriów'); ?><!--</p>     <div class="content-calc__additional js-show-additional-discount text-center">-->
                            <!--                            --><?php //echo Polylang\t9n('Odbierz dodatkowy rabat'); ?><!-- &nbsp;<img-->
                            <!--                                    src="--><?//= esc_url(Assets\asset_path('images/r_arrow.png',
