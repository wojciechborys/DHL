...
$title = get_field('services_customs__title');
$text = get_field('services_customs__text');
$id = get_field('services_customs__ID');
?>
<section class="services_accordion services_accordion--2">
    <div class="container">
        <hr>
        <div class="services_accordion--2--title"></div>
        ...
        <div class="pt-1">
            <?php if (have_rows('services_customs__repeat')):
                $k = 1;
                while (have_rows('services_customs__repeat')) : the_row(); ?>
                    ...
                    <?php endif; ?>
                        <div id="ts<?php echo $k; ?>" <?php if(get_sub_field('title')){ ?> style="display: none;" <?php } ?> >
                         <?php if (have_rows('accordion')): ?>
                            ...
                            <?php while (have_rows('accordion')) : the_row(); ?>
                                <div class="services_accordion--item">
                                    ...
                                    <div id="ss<?php echo $k.$m; ?>" class="services_accordion--content" style="display: none;">
                    ...
                    <div class="col-12 pt-1 pb-5 text-center text-sm-left">
