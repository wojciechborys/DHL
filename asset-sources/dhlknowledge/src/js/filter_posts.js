...
jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.pagination a', function (event) {
        ...
        var action = 'ajax_pagination';
        if($('#knowledgePosts').hasClass('media')) {
  ...
  $(document).on("click", ".js-more-press-release", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        console.log("testuje");
        console.log(data);
        $('#morePressReleaseButton').remove();
        $("#morePressRelease").append(data.data);
      },
      async: true
    });
  });
