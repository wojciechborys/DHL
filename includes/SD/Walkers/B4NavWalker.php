...
class B4NavWalker extends \Walker_Nav_Menu
{
    /**
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        // New
        $class_names .= ' nav-item navbar__nav-item';
        ...
        // New
        if ($depth === 0) {
            $atts['class'] = 'nav-link navbar__nav-link';
        }
        ...
        */
        //
        $item_output .= '<a'. $attributes .' data-nav-link>';
