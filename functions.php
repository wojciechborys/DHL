...
{   
    ...
    if(is_tax()) {
        ...
        if ($taxonomy->parent) {
            $taxonomy_url = get_term_link($taxonomy->parent);
        } else {
            $taxonomy_url = get_term_link($taxonomy->term_id);
        }
    } else {
        $taxonomy_url = $first_page_url.'/';
    }
    ...
    if ($first_link_in_the_middle >= 3 && $links_in_the_middle < $max_page) {
        $pagination .= '<li class="page-item"><a href="' . $taxonomy_url . $search_query . '/" class="page-numbers page-link">1</a></li>';
    ...
    if ($current_page != 1)
        $pagination .= '<li class="page-item"><a href="' . $taxonomy_url . 'page/' . ($current_page - 1) . $search_query . '/" class="prev page-link page-numbers" aria-label="Previous">' . ' <span aria-hidden="true">
    ...
    for ($i = $first_link_in_the_middle; $i <= $last_link_in_the_middle; $i++) {
        if ($i == $current_page) {
            ...
            $pagination .= '<li class="page-item"><a href="' . $taxonomy_url . 'page/' . $i . $search_query . '/" class="page-numbers page-link">' . $i . '</a></li>';
        }
    }

    // arrow right (next page)
    if ($current_page != $last_link_in_the_middle)
        $pagination .= '<li class="page-item"><a href="' . $taxonomy_url . 'page/' . ($current_page + 1) . $search_query . '/" class="next page-link page-numbers" aria-label="Next">' . ' <span aria-hidden="true">
    ...
    if ($last_link_in_the_middle < $max_page) {
        ...
        $pagination .= '<li class="page-item"><a href="' . $taxonomy_url . 'page/' . $max_page . $search_query . '/" class="page-link page-numbers">' . $max_page . '</a></li>';
    }
...
//enable aditional file extension
